    ...
    <form class="w-full">
      ...
      <div class="flex pb-5 gap-4 items-center justify-between">
        ...
        <div class="w-1/2">
          ...
          <input type="text" id="roll" class="bg-white focus:outline-blue-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-100 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>
      </div>
      <div class="flex pb-5 gap-4 items-center justify-between">
        <div class="w-1/2">
      ...
      <div class="flex gap-5 items-center justify-center">
        <button type="button" @click="addStudent" class="bg-blue-500 px-16 py-2 rounded-full text-white text-center">Add</button>
